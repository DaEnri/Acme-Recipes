...
public class ChefKitchenItemIngredientListShowTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/chef/kitchen-item/list-ingredient.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
