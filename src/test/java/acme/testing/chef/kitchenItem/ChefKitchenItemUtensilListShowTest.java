...
public class ChefKitchenItemUtensilListShowTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/chef/kitchen-item/list-utensil.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
