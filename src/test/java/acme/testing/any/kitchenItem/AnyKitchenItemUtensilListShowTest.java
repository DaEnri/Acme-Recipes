...
public class AnyKitchenItemUtensilListShowTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/any/kitchen-item/list-utensil.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTest(final int recordIndex, final String type, final String name, final String code, final String description, final String retailPrice, final String published, final String optionalLink) {
		...
		super.clickOnMenu("Anonymous", "Published kitchen utensils");
